...
SCHEMA_PATH = Path(__file__).resolve().parent.parent / "schemas" / "frame-analysis.schema.json"
EXAMPLE_PATH = Path(__file__).resolve().parent.parent / "schemas" / "frame-analysis.example.json"
